...
/* package haskell-pet-0.1.0.0 */
#ifndef VERSION_haskell_pet
#define VERSION_haskell_pet "0.1.0.0"
#endif /* VERSION_haskell_pet */
#ifndef MIN_VERSION_haskell_pet
#define MIN_VERSION_haskell_pet(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_pet */
...
#define CURRENT_COMPONENT_ID "haskell-pet-0.1.0.0-inplace-haskell-pet"
